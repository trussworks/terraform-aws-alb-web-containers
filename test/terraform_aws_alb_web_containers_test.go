...
func TestTerraformAwsAlbWebContainersSimpleHttpCustomPrefix(t *testing.T) {
	t.Parallel()

	tempTestFolder := test_structure.CopyTerraformFolderToTemp(t, "../", "examples/s3-prefix")
...
func TestTerraformAwsAlbWebContainersSimpleHttpDisabledPrefix(t *testing.T) {
	t.Parallel()

	tempTestFolder := test_structure.CopyTerraformFolderToTemp(t, "../", "examples/s3-prefix-disabled")
